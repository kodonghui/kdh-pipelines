...
Persona: Read _bmad/bmm/agents/{file}.md with Read tool BEFORE anything else.
Expertise: {expertise from roster above}
Rubric: _bmad-output/planning-artifacts/critic-rubric.md (D1-D6, /4→/10). A: ≥8.0, B: ≥7.5. Any dim <3 = auto-fail.
Refs: project-context.yaml + context-snapshots + {stage-specific}
```
